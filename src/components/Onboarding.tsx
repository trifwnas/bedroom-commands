...
const STEPS = [
  { emoji: '💕', title: 'Welcome to Bedroom Commands', desc: 'A fun couples card game with 250+ commands across 5 categories', color: '#ff6b6b' },
  ...
  { emoji: '⚙️', title: 'Customize', desc: 'Add your own commands, toggle categories, and personalize your experience', color: '#4d96ff' },
];
